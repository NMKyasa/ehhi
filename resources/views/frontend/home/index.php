                            ...
                            <div class="team-social">
                                <?php if (!empty($member['facebook_url'])): ?>
                                    <a class="btn btn-square btn-dark rounded-circle m-1"
                                        href="<?= htmlspecialchars($member['facebook_url']) ?>"
                                        target="_blank">
                                ...
                                <?php if (!empty($member['twitter_url'])): ?>
                                    <a class="btn btn-square btn-dark rounded-circle m-1"
                                        href="<?= htmlspecialchars($member['twitter_url']) ?>"
                                        target="_blank">
                                ...
                                <?php if (!empty($member['linkedin_url'])): ?>
                                    <a class="btn btn-square btn-dark rounded-circle m-1"
                                        href="<?= htmlspecialchars($member['linkedin_url']) ?>"
                                        target="_blank">
                                ...
                                <?php if (!empty($member['instagram_url'])): ?>
                                    <a class="btn btn-square btn-dark rounded-circle m-1"
                                        href="<?= htmlspecialchars($member['instagram_url']) ?>"
                                        target="_blank">
